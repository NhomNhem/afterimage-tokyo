# m0-locomotion-tuning-scriptableobject Specification

## Purpose
TBD - created by archiving change externalize-m0-locomotion-tuning-to-scriptableobject. Update Purpose after archive.
## Requirements
