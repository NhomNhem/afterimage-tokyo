# m0-gameplay-tick-memory-bridge Specification

## Purpose

Preserve the behavior and ownership boundaries for the ADR-guided extraction of memory-related orchestration from `M0GameplayTickHandler` into a narrow runtime bridge.
