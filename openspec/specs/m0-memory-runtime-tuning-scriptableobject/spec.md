# m0-memory-runtime-tuning-scriptableobject Specification

## Purpose
TBD - created by archiving change externalize-m0-memory-runtime-tuning-to-scriptableobject. Update Purpose after archive.
## Requirements
