# m0-combat-tuning-scriptableobject Specification

## Purpose
TBD - created by archiving change externalize-m0-combat-tuning-to-scriptableobject. Update Purpose after archive.
## Requirements
