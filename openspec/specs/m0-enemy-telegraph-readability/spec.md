# M0 Enemy Telegraph Readability

## Purpose

Define the read-only enemy telegraph readability contract for the M0 duel loop so players, debug tooling, and presentation observers can understand enemy phase, timing, attack tags, defensive answer, and punish availability without moving gameplay authority out of Enemy Intent or Combat Core.
