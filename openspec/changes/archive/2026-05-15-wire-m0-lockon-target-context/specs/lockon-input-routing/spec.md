# Spec: LockOn Input Routing

## Overview

Capability for Input Mapping to emit raw `LockOn` intent without target selection, validation, or truth ownership.
...
None. This is a new capability introducing LockOn input handling.
