# Spec: Target Manual DI

## Overview

Capability for manual VContainer registration of Target Context services in `GameplayScope` without generated DI or automatic scanning.
...
None. This is a new capability introducing manual DI wiring for Target Context.
