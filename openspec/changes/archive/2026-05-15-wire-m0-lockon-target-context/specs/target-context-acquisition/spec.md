# Spec: Target Context Acquisition

## Overview

Capability for Target Context to acquire the single M0 enemy as the active target when no target is currently active.
...
None. This is a new capability introducing target acquisition behavior.
