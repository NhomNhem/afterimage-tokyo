# S2-4 — Lock-On Combat Camera Readability Implementation Pass

## Change

- Name: `implement-m0-lockon-camera-readability`
...
- Implement the smallest safe lock-on camera readability pass in existing M0 camera code.
- Preserve ownership boundaries and avoid gameplay-truth migration to camera.
- Add focused EditMode coverage for camera movement basis readability behavior.
- Capture focused S2-4 evidence with PASS/PARTIAL/FAIL classification.
